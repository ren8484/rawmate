...
- 当前正式版本：`1.1.0`；Windows Assembly/FileVersion 为 `1.1.0.0`。
...
- P/X 旗标与星级。
- 自动前进开关。
- 左侧栏左下角固定显示当前产品版本；界面从程序集信息版本自动生成，例如 `1.1.0` 显示为 `V1.10`，不维护第二份硬编码版本号。
...
- GitHub 正式标签使用三段语义版本（如 `v1.1.0`）；Windows 文件属性使用四段版本（如 `1.1.0.0`）。
